...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  TString NIM_path = "../ROOT";
  TString out_path = "../ROOT";
  TString Sync_path = "../ROOT";
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(Form("%s/run_0094/run_0094_0000.dat.root",DC_path.Data()));
      if (!f || !f->IsOpen()) {
	//f = new TFile("run_0094_calib.root");
	f = new TFile(Form("%s/run_0094/run_0094_0000.dat.root",DC_path.Data()));
      }
