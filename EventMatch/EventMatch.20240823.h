...
// found on file: ../ROOT/test_0808/run_7/MSE000007.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  virtual void     TS_Event_Matching(int runN, Double_t accuracy_ns);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOT/test_0808/run_7/MSE000007.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOT/test_0808/run_7/MSE000007.root");
      }
